...
switch ($_SERVER['HTTP_HOST']) {
	...
	/*
		Dev gegevens voor database
	*/
	case 'nierstichting.dev':
		$db['default']['hostname'] = 'prod02.backyard-cms.nl';
	...
	/*
		...
		is kan het systeem de $_SERVER variabelen niet lezen dus 
		gaat ie over op default.
	*/
	default:
